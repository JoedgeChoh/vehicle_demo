...
if("FALSE" STREQUAL "TRUE")
  set(vehicle_SOURCE_PREFIX /home/zhuhe/zhuhe/vehicle_demo/src/vehicle)
  set(vehicle_DEVEL_PREFIX /home/zhuhe/zhuhe/vehicle_demo/devel)
  set(vehicle_INSTALL_PREFIX "")
  set(vehicle_PREFIX ${vehicle_DEVEL_PREFIX})
else()
  set(vehicle_SOURCE_PREFIX "")
  set(vehicle_DEVEL_PREFIX "")
  set(vehicle_INSTALL_PREFIX /home/zhuhe/zhuhe/vehicle_demo/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'software <software@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vehicle' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
